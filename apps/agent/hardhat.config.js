...
module.exports = {
  ...
  aragon: {
    appEnsName: "agent.aragonpm.eth",
    appContractName: "Agent",
    appRoles: [
      {
      ...
      },
      {
        ...
        id: "EXECUTE_ROLE",
        params: ["Target address", "ETH value", "Signature"],
      },
      {
        name: "Execute safe actions",
        id: "SAFE_EXECUTE_ROLE",
        params: ["Target address", "Signature"],
      },
      {
      ...
      {
        name: "Set designated signer",
        id: "DESIGNATE_SIGNER_ROLE",
        params: ["Designated signer address"],
      },
      {
        name: "Run EVM Script",
        id: "RUN_SCRIPT_ROLE",
